            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="alert alert-danger bg-red-200 text-red-800 border border-red-800 rounded-md p-4 mb-4">
                    ...
                    <form method="POST" action="{{ route('roles.update', ['role'=>$role] ) }}">
                        ...
                        Name:
                        <br />
                        <input  type="text" name="name" value="{{ $role->name }}" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                        <br /><br />
                        Permission:
                        <br />
